  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        md: "0 4px 12px rgb(0 0 0 / 0.06), 0 1px 4px rgb(0 0 0 / 0.04)",
        lg: "0 8px 24px rgb(0 0 0 / 0.08), 0 2px 8px rgb(0 0 0 / 0.04)",
        xl: "0 12px 40px rgb(0 0 0 / 0.1), 0 4px 12px rgb(0 0 0 / 0.06)",
        "accent-glow": "0 0 20px rgb(14 165 233 / 0.2)",
        "dark-sm": "0 1px 3px rgb(0 0 0 / 0.3)",
        "dark-md": "0 4px 12px rgb(0 0 0 / 0.3)",
        "dark-lg": "0 8px 24px rgb(0 0 0 / 0.4)"
      },
      colors: {
        nada: {
        ...
        /* Legacy aliases for backwards compat with existing Tailwind classes */
        accent: "rgb(var(--nada-accent) / <alpha-value>)",
