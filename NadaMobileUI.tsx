...
export const SearchBar = ({
  ...
  <div className="px-5 pt-3 pb-1.5">
    <div className="flex items-center gap-2">
      ...
      <span className="nada-secure-badge shrink-0">
...
/* ─────────────────────────────────────────────────────────────
   FilterTabBar — All / Unread / Vanish / Groups pill bar
   ───────────────────────────────────────────────────────────── */
export const FilterTabBar = ({
  ...
  const filters = ["All", "Unread", "Vanish", "Groups"];
  return (
    <div className="flex items-center gap-2 px-5 pb-2 pt-1">
      {filters.map((filter) => (
        <button
          ...
          className={cn(
            "nada-filter-pill",
            activeFilter === filter.toLowerCase() && "nada-filter-pill-active"
          )}
        >
          {filter}
        </button>
...
export const ChatListItem = ({
  ...
  <div className={cn(
    ...
    <div className="relative shrink-0">
      <div className={cn(
        "flex h-[54px] w-[54px] items-center justify-center overflow-hidden rounded-full font-semibold transition-all duration-200",
        unreadCount > 0
          ...
          {isOnline && (
            <span
              ...
              style={{
                ...
                boxShadow: "0 0 6px rgba(30,215,130,0.7)"
              }}
            />
          )}
        </h3>
...
export const DesktopNavRail = ({
  ...
  return (
    ...
    >
      <div className="mb-3 grid h-10 w-10 place-items-center overflow-hidden rounded-full nada-logo-aura">
...
export const MobileHeader = ({
  ...
  const title = activeTab === "chats" ? "Chats" : TAB_TITLES[activeTab] ?? "NADA";
  ...
  return (
    ...
    >
      <div className="flex min-w-0 flex-col">
        ...
        {activeTab === "chats" && (
          <span className="mt-0.5 text-[11px] font-medium text-nada-secondary/55" style={{ paddingLeft: "calc(40px + 14px)" }}>
            8 ghosts · all encrypted
          </span>
        )}
      </div>
      ...
      >
        <Edit3 className="h-[19px] w-[19px] text-nada-primary/85" strokeWidth={2.4} />
      </motion.button>
    </header>
  );
};
...
export const EmptyChatListState = ({ onAdd }: { onAdd: () => void }) => (
  <div className="flex flex-col items-center justify-center px-10 py-20 text-center">
    ...
    >
      <div
        className="absolute inset-0 rounded-full opacity-60 blur-2xl animate-logo-glow"
        style={{
          background:
      ...
      />
      <div
        className="relative flex h-[96px] w-[96px] items-center justify-center rounded-full border border-nada-border/[0.08]"
        style={{
          background:
...
export const ProfileHeader = ({
  ...
  <div className="flex flex-col items-center px-6 py-10 text-center">
    ...
    >
      <div
        className="absolute inset-0 rounded-full opacity-55 blur-3xl animate-logo-glow"
        style={{
          background:
      ...
      />
      <div
        className="relative flex h-[112px] w-[112px] items-center justify-center overflow-hidden rounded-full font-semibold"
        style={{
          background:
